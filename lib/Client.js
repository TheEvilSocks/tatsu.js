...
const https = require('https');
 ...
 class Client {
	 ...
	 * @return Object.pong {Boolean}
	 * @return Object.ping {Number} The ping in milliseconds. This is calculated client side.
	 */
 	ping() {
 		return this.doReq(() => {
 			return new Promise((fulfill, reject) => {
	 			...
	 			this.doApi(Constants.API.PING, {}).then(ping => {
	 				fulfill(Object.assign({ping: Date.now() - begin}, ping));
	 			}, reject);
	 		});
 		});
